#require module for UNC Cluster Computing
...
#naming convention for decrease to fitness
...
#Analysis: generate lag phase file
...
#Analysis: generate genotype over time file
...
#Analysis: generate source genotypes file
...
#Analysis: generate population over time file
